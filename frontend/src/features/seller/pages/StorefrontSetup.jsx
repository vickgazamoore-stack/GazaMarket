			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
				...
				<div className="border rounded-xl p-6 space-y-4" style={{ borderColor: "var(--border)" }}>
					<div>
						...
						<input
							type="text"
							defaultValue="Nnamdi Tech Market"
					...
					<div>
						...
						<textarea
							rows={4}
							defaultValue="Premium electronics and accessories with fast delivery."
							className="mt-1 w-full px-3 py-2 rounded-lg border focus:outline-none"
							style={{ borderColor: "var(--border)", color: "var(--text)" }}
						/>
					</div>
					...
					<div>
						...
						<textarea
							rows={3}
							placeholder="Return policy, shipping timelines, warranty..."
							className="mt-1 w-full px-3 py-2 rounded-lg border focus:outline-none"
							style={{ borderColor: "var(--border)", color: "var(--text)" }}
						/>
					</div>
